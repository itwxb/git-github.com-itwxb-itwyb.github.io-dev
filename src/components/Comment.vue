<template>
  <div id="comment" :class="{ active: isProgress }">
    <div class="baseline comments-word" data-text="添加评论">
      <a :href="url" target="_blank" class="commenter-name-link"
        ><strong>添加评论</strong></a
      >
    </div>
    ...
    <div
      v-show="!!comments.length && !hasMoreComment"
      class="baseline"
      data-text="没有更多评论"
    ></div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      repoName: "itwxb.github.io",
      url: "https://github.com/itwxb/itwxb.github.io/issues/",
    };
  },
  props: {
